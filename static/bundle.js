...
* playground.js
******************************/
!function(e,t){"function"==typeof define&&define.amd?define([],t(e)):"object"==typeof exports?module.exports=t(e):e.initConverter=t(e)}("undefined"!=typeof global?global:this.window||this.global,(function(e){"use strict";const t={selectors:[],standard:!1,lowercase:"",uppercase:"",html:"",showHtmlBox:!1,save:function(){this.saveValue("selectors",JSON.stringify(t))},load:function(){const e=this.loadValue("selectors");if(e){const t=JSON.parse(e);t&&(this.selectors=t.selectors,this.html=t.html,this.showHtmlBox=t.showHtmlBox)}},loadValue:function(e){try{return localStorage.getItem(e)}catch(e){}return null},saveValue:function(e,t){try{t!==localStorage.getItem(e)&&localStorage.setItem(e,t)}catch(e){}}},n=document.getElementById("debug"),o=document.getElementById("up-btn"),c=document.getElementById("down-btn"),s=document.getElementById("css-box"),r=(document.getElementsByTagName("body")[0],document.getElementById("convert")),l=document.getElementById("clear-css"),a=document.getElementById("axis"),i=document.getElementById("translate"),d=document.getElementById("selector-history"),u=document.getElementById("lowercase"),m=document.getElementById("to-lowercase"),h=document.getElementById("uppercase"),f=document.getElementById("to-uppercase"),p=document.getElementById("console-use"),g=document.getElementById("xpath-box"),y=document.getElementById("copy-code"),E=document.getElementById("message-box"),v=document.querySelector("details.html"),b=document.getElementById("html-box"),x=document.getElementById("run-xpath"),w=document.getElementById("run-css"),L=document.getElementById("html-list"),I=document.getElementById("clear-html");new autoComplete(s,{suggestions:[autocompleteCSS,htmlTags,htmlAttributes.map((e=>e.replace("@","[")))],regex:/(^|[\s"'*./:=>+~^!@()[\]\\|]|[a-z](?=:)|[\s\w](?=\[))([:[@]?\w+[\w-]+)$/u,threshold:2,startsWith:!0,listItem:(e,t)=>{M(e)},debug:!n.checked}),new autoComplete(g,{suggestions:[autocompleteXPath,htmlTags,htmlAttributes],regex:/(?<trigger>^|[\s"'*./:=([\\|]|[/[](?=@))(?<query>[@]?[\w-]+)$/u,threshold:2,startsWith:!0,highlight:!0,listItem:(e,t)=>{M(e)},debug:!n.checked});const C=CodeJar(s,null,{tab:"  "}),k=CodeJar(g,null,{tab:"  "}),B=CodeJar(b,null,{tab:"  "}),T={axis:".//",standard:!1,uppercaseLetters:"",lowercaseLetters:"",printError:e=>g.innerHTML='<span class="errors">'+e+"</span>"};let H=!1,S=!1,N="",A=0;function M(e){const t=(e=e.querySelector("mark")||e).textContent;/^[@:[]/.test(t)&&(e.textContent=t.substr(1))}function O(e){try{return html_beautify(e)}catch(t){return e}}function P(){try{const e=JSON.parse(d.value);e&&(C.updateCode(e.selector),a.value=e.axis||".//",h.value=e.uppercase||"",u.value=e.lowercase||"")}catch(e){}}function R(e){g.focus(),k.recordHistory(),k.updateCode(""),e&&g.blur()}function q(e){g.focus(),k.recordHistory(),k.updateCode(e),g.blur()}function X(){E.innerHTML="",E.className="hide",new Mark(b).unmark()}function $(){X();const e=N||s.textContent.trim();if(!e)return;N="",q("");const o=a.value;T.axis=o,T.standard=p.checked,T.consoleUse=p.checked,T.translate=i.checked,T.postprocess=!!n.className||n.checked,T.uppercaseLetters=h.value.trim(),T.lowercaseLetters=u.value.trim(),T.debug=!n.checked;const{xpath:c,css:r,warning:l,error:d}=toXPath(e,T);var m;if(l&&(m=l,E.style.color="red",E.innerHTML=m.trim(),E.className=""),c&&q(p.checked?'$x("'+c+'")':c),v.hasAttribute("open")&&c){const t=function(e,t){let n,o="",c=!0,s=[],r=[];const{doc:l}=J();if(!l)return"";try{s=l.querySelectorAll(e)}catch(e){o+="Selector is not valid; ",c=!1}c&&(o+="Selector: count = "+s.length+"; ");c=!0;try{const e=l.evaluate(t,l,null,XPathResult.ORDERED_NODE_ITERATOR_TYPE,null);for(;n=e.iterateNext();)r.push(n)}catch(e){o+="XPath is not valid; ",c=!1}c&&(o+="XPath: count = "+r.length+";");if(s.length&&r.length){let e=0,t=0;for(let n=0;n<s.length;n++)s[n]===r[n]?e++:t++;t&&(o+=" Elements are <b>not reference equals</b>:<br>equals = "+e+"; not equals = "+t)}c&&(0===r.length&&s.length>0||s.length!==r.length)&&!T.translate&&/translate\(/.test(t)&&(o+="\n<b>Note</b> that <b>translate</b> checkbox is unchecked.");return o.replaceAll("; ",";<br>")}(e,c);D(c),t&&(E.innerHTML=t)}return d?void 0:(W(e,o),H&&(t.save(),H=!1),j(),c)}function _(e){const t=window.getSelection();return t&&e.contains(t.anchorNode)?t.toString().trim():""}function D(e,n){X();const{doc:o,htmlString:c,indexes:s}=J();if(!o)return;let r,l;try{l=o.evaluate(e,o,null,XPathResult.ORDERED_NODE_ITERATOR_TYPE,null)}catch(e){return void z(e)}const a=[];for(;r=l.iterateNext();)for(let e=0;e<s.length;e++)if(r===s[e].node){a.push(s[e].startIndex);break}B.updateCode(c),V(a,"XPath: "),t.html=c}function J(){let e=b.textContent;if(!e.trim())return{};const t=(new DOMParser).parseFromString(e,"text/html"),n=t.documentElement.outerHTML,o=function(e,t){const n=NodeFilter.SHOW_ELEMENT|NodeFilter.SHOW_TEXT,o=document.createNodeIterator(e,n),c=[];let s,r=0;for(;s=o.nextNode();){const e=3===s.nodeType?s.nodeValue:s.outerHTML,n=t.indexOf(e,r);if(-1!==n){const t=3===s.nodeType?e.length:e.indexOf(">"+s.innerHTML+"<",3)+1;r=n+(t<0?1:t),c.push({node:s,startIndex:n})}}return c}(t,n);return{doc:t,htmlString:n,indexes:o}}function V(e,t){const o=e.length;if(U(t+"count = "+o),!o)return;const c=new Mark(b),s=/<[A-Za-z][\w:-]*(?:[^>"']+|"[^"]*"|'[^']*')*>|[^<]+/y;let r=0;if(s.lastIndex=e[r],c.unmark().markRegExp(s,{acrossElements:!0,each:()=>{++r<o?s.lastIndex=e[r]:s.lastIndex=1/0},done:(e,t)=>{t!==o&&U("main.js: Indexes count "+o+" !== "+t+" number of highlighted elements")}}),!n.checked)return;const l=b.querySelector("mark");l&&(l.scrollIntoView({block:"center"}),document.getElementById("demo")?.scrollIntoView(),scrollBy(0,-10))}function z(e){E.style.color="red",E.innerHTML=e.message||"Error",E.className="",console.error(e)}function U(e){E.style.color="black ",E.innerHTML=e,E.className=""}function W(e,n){e=e.replace(/'/g,"&#39;");const o=t.selectors.length;t.selectors=t.selectors.filter((t=>t.selector&&t.selector!==e)),o===t.selectors.length&&(H=!0);const c=h.value.trim(),s=u.value.trim();t.selectors.unshift({selector:e,axis:n,lowercase:s,uppercase:c}),t.selectors.length>30&&t.selectors.pop()}function j(){let e="";t.selectors.forEach((t=>{if(!t.selector)return!0;e+="<option value='"+JSON.stringify(t)+"'>"+t.selector+"</option>"})),d.innerHTML=e}function Y(e,t){const n=['<a href="#info-1">[1]</a> ','<a href="#info-2">[2]</a> ','<a href="#info-3">[3]</a> '],o=[];return o.push('<table><thead><tr><th>Description</th><th>CSS</th><th class="thead-xpath">XPath</th></tr></thead><tbody>'),e.forEach((e=>{if(/^\$\$/.test(e[0])){let t=e[0].substring(2);const n=t.replace(/\W+/g,"_").toLowerCase();t=t.replace(" non-standard",""),o.push('<tr class="group"><td id="',n,'">',t,"</td><td>"+(e[1]||"")+'</td><td><span class="example-info">'+(e[2]||"")+"</span></td></tr>")}else{const c=e[2]?e[2].split(" ").map((e=>n[e])).join(""):"";T.standard=void 0===e[3];let{xpath:s,css:r,warning:l,error:a}=toXPath(e[0],T);if(s){s=s.replace(/ABCDEFGHJIKLMNOPQRSTUVWXYZ[^']*/g,"ABC...").replace(/abcdefghjiklmnopqrstuvwxyz[^']*/g,"abc...");const n=e[1]?e[1].replace(/ (n\d?)(?= |$)/g," <i>$1</i>"):" - ";o.push('<tr><td class="name">',c,n,"</td>"),t?o.push('<td class="css"><code class="css" data-selector="',e[0],'">',e[0].replace(/ +/g,"&nbsp;"),"</code></td>"):o.push('<td class="css"><code>',e[0].replace(/ +/g,"&nbsp;"),"</code></td>"),o.push('<td><code class="xpath">',s,"</code></td></tr>")}a&&console.log(e[0],a)}})),o.push("</tbody></table>"),o.join("")}"file:"===location.protocol&&(n.className=""),async function(){await async function(){return new Promise((e=>{const t=document.getElementById("examples");t.innerHTML=Y(exampleSelectors,!0),t.querySelectorAll("code.css").forEach((e=>{e.addEventListener("click",(function(e){!function(e){l.click();const t=e.getAttribute("data-selector");var n;n=t,s.focus(),C.recordHistory(),C.updateCode(n),s.blur(),e.classList.add("visited"),scrollBy(0,-90)}(this)})),e.addEventListener("mouseover",(function(e){!function(e){A=e.getBoundingClientRect().top+window.scrollY}(this)}))})),document.getElementById("attribute-table").innerHTML=Y(classAttributes),e()}))}()}(),function(){let e='<option value="">'+defaultHtmls.name+"</option>";for(const e in defaultHtmls)t(e,defaultHtmls);function t(t,n){if("name"!==t){let n=t.replace(/^[a-z]/,(e=>e.toUpperCase())).replace(/[a-z](?=[A-Z])/g,"$& ");n=n.replace(/( [A-Z])([a-z]+)/g,((e,t,n)=>t.toLowerCase()+n)),e+=`<option value="${t}">${n}</option>`}}L.innerHTML=e}(),t.load(),t.selectors&&t.selectors.length&&(j(),P(d.value)),t.html&&t.html.length&&(B.updateCode(t.html),t.showHtmlBox&&v.setAttribute("open",!0)),C.onUpdate((()=>{H=!0})),B.onUpdate(((e,t)=>{H=!0,S&&t&&("paste"===t.type||"drop"===t.type)&&B.updateCode(O(e)),S=!1})),window.addEventListener("beforeunload",(function(e){if(H){const e=s.innerText.trim();e&&W(e,a.value);const n=b.textContent;n.trim()&&(t.html=n),t.save()}})),L.addEventListener("change",(function(e){const t=defaultHtmls[this.value]?.content;t&&(b.focus(),B.updateCode(O(t)),B.recordHistory(),b.blur())})),d.addEventListener("change",(function(e){P(this.value),setTimeout((function(){$()}),100)})),s.addEventListener("paste",(function(e){setTimeout((function(){$()}),100)})),n.addEventListener("click",(function(){$()})),i.addEventListener("click",(function(){$()})),p.addEventListener("click",(function(){$()})),y.addEventListener("click",(function(){document.getSelection().selectAllChildren(this.parentNode),document.execCommand("copy"),document.getSelection().removeAllRanges()})),a.addEventListener("change",(function(e){$()})),m.addEventListener("click",(function(){const e=h.value.trim();e&&(u.value=e.toLowerCase())})),f.addEventListener("click",(function(){const e=u.value.trim();e&&(h.value=e.toUpperCase())})),o.addEventListener("click",(function(){window.scrollTo(0,0)})),c.addEventListener("click",(function(){const e=window.pageYOffset,t=e+screen.height-150,n=screen.height/7;0===A||A<t&&A>e?window.scrollTo(0,1e4):(window.scrollTo(0,A),window.scrollBy(0,-n))})),r.addEventListener("click",(function(){N=_(s),X(),R(!0),setTimeout((function(){$()}),10)})),v.addEventListener("toggle",(function(){const e=this.hasAttribute("open");t.showHtmlBox=e,H=!0,X(),e&&(b.focus(),B.recordHistory(),b.textContent.trim()||B.updateCode(defaultHtmls.page.content),b.blur())})),x.addEventListener("click",(function(){let e=_(g)||g.textContent.trim();if(e)D(e);else{if(!s.textContent.trim())return;$()}})),w.addEventListener("click",(function(){!function(){X();const e=_(s)||s.innerText.trim();if(!e)return;const{doc:n,htmlString:o,indexes:c}=J();if(!n)return;let r;try{r=n.querySelectorAll(e)}catch(e){return void z(e)}const l=[];for(let e=0;e<r.length;e++)for(let t=0;t<c.length;t++)if(r[e]===c[t].node){l.push(c[t].startIndex);break}B.updateCode(o),V(l,"CSS: "),t.html=o}()})),l.addEventListener("click",(function(){var e;s.focus(),C.recordHistory(),C.updateCode(""),e&&s.blur(),R(!0),X(),s.focus(),H=!0})),I.addEventListener("click",(function(){b.focus(),B.recordHistory(),B.updateCode(""),S=H=!0}))}));
